...
PRODUCT_COPY_FILES +=\
    device/lineage/atv/privapp-permissions/privapp-permissions-lineage-atv.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/permissions/privapps-permissions-lineage-atv.xml
